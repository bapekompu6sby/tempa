        ...
        <div class="container mx-auto flex items-center justify-between">
            ...
            <nav>
                @if(session('access_granted'))
                    ...
                    <a href="{{ route('events.index') }}" class="text-base font-semibold mr-4" style="color:#FDB714">Pelatihan</a>
                    <a href="{{ route('asn.index') }}" class="text-base font-semibold" style="color:#FDB714">ASN</a>
                @endif
            </nav>
        </div>
    </header>
