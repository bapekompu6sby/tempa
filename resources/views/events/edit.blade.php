        ...
        <div class="mb-4 mt-8">
            ...
            <div class="flex items-center space-x-4">
                <label class="flex flex-col items-center px-4 py-6 bg-white text-blue-600 rounded-lg shadow-lg tracking-wide border border-blue-200 cursor-pointer hover:bg-blue-50 transition">
                    ...
                    <span class="mt-2 text-base leading-normal">Pilih file (PDF/DOC/DOCX/RAR/ZIP)</span>
                    <input type="file" name="event_report_file" id="event_report_file" class="hidden" accept=".pdf,.doc,.docx,.zip,.rar" onchange="document.getElementById('event-report-selected').textContent = this.files.length ? this.files[0].name : ''">
                </label>
